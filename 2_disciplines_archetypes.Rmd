...
```{r}
# It includes the profiles classification by field
arcfull3_sub_plot <- read.csv2(paste0('data/profiles/', area, '.csv'))

arcfull3_sub_plot$Label[which(arcfull3_sub_plot$Label=='Bicultural Scholar')] <- 'The Bridger'
arcfull3_sub_plot$Label[which(arcfull3_sub_plot$Label=='Global scholar')] <- 'The Cosmopolitan'
arcfull3_sub_plot$Label[which(arcfull3_sub_plot$Label=='Traditionalist')] <- 'The Local Chronicler'
arcfull3_sub_plot$Label[which(arcfull3_sub_plot$Label=='Monograph specialist')] <- 'The Sage'
arcfull3_sub_plot$Label[which(arcfull3_sub_plot$Label=='Omni-publication scholar')] <- 'The Polymath'
arcfull3_sub_plot$Label[which(arcfull3_sub_plot$Label=='Versatile chapter author')] <- 'The Participant'

arcfull3_sub_plot$Label <- factor(arcfull3_sub_plot$Label, levels=sort(unique(c('The Bridger',
                                                                               'The Cosmopolitan',
                                                                               'The Local Chronicler',
                                                                               'The Sage',
                                                                               'The Polymath',
                                                                               'The Participant')), decreasing = FALSE), ordered=TRUE)

ggplot(arcfull3_sub_plot, aes(x = First_pub, fill = Label)) +
  geom_histogram(
    position = "fill",
    binwidth = 3,
    boundary = 1950,
  ...
  scale_x_continuous(breaks = seq(1960, 2020, 20), expand = c(0,0)) +
